...
class ItemFilterPopup extends StatefulWidget {
  final Function(String, String, String, String, String, String, String, String,
      String, bool) onSubmit; // Define callback function
...
class _ItemFilterPopupState extends State<ItemFilterPopup> {
  ...
  void submitDate() {
    ...
    widget.onSubmit(formattedFromDate, formattedToDate, itemCode, brand,
        category, subCategory, type, brandCode, stockPlace, allStockPlaces);
            ...
            : Column(
                ...
                children: [
                          ...
                          items: [
                            DropdownMenuItem<String>(
                              child: Text(businessTypeId == 27
                                  ? 'Select Company Name'
                                  : 'Select Stock Place'),
                              value: '', // Representing a null value
                            ),
                            ...stockPlaceList
                  ...
                  Row(
                    ...
                    children: [
                      Checkbox(
                          value: allStockPlaces,
                          onChanged: (bool? value) {
                            setState(() {
                              allStockPlaces = value!;
                            });
                            if (allStockPlaces) {
                              setState(() {
                                stockPlace = '';
                      ...
                      TextButton(
                        child: Text('All Stock Places'),
                        onPressed: () {
                          setState(() {
                            allStockPlaces = !allStockPlaces;
                          });
                          if (allStockPlaces) {
                            setState(() {
                              stockPlace = '';
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          controller: fromDate,
                          decoration: InputDecoration(
                              hintText: 'From', border: borderStyle),
