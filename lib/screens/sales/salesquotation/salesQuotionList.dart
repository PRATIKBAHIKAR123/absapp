...
class SalesQuatationListScreen extends StatefulWidget {
  const SalesQuatationListScreen({super.key});

  @override
  State<SalesQuatationListScreen> createState() => _SalesQuatationListScreen();
}

class _SalesQuatationListScreen extends State<SalesQuatationListScreen> {
