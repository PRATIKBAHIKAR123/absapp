...
class MaterialOutScreen extends StatefulWidget {
  ...
  @override
  State<MaterialOutScreen> createState() => _MaterialOutScreen();
}

class _MaterialOutScreen extends State<MaterialOutScreen> {
  ...
  Future<void> setuInfoData() async {
    setupInfoData = await getSetupInfoData(29, true, currentSessionId);
