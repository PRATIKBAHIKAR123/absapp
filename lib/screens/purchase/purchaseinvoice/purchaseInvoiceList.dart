...
class PurchaseInvoiceListScreen extends StatefulWidget {
  ...
  State<PurchaseInvoiceListScreen> createState() =>
      _PurchaseInvoiceListScreen();
}

class _PurchaseInvoiceListScreen extends State<PurchaseInvoiceListScreen> {
  ...
  Future<void> setuInfoData() async {
    setupInfoData = await getSetupInfoData(9, true, currentSessionId);
