...
class JournalVoucherListScreen extends StatefulWidget {
  const JournalVoucherListScreen({super.key});

  @override
  State<JournalVoucherListScreen> createState() => _JournalVoucherListScreen();
}

class _JournalVoucherListScreen extends State<JournalVoucherListScreen> {
  ...
  Future<void> setuInfoData() async {
    setupInfoData = await getSetupInfoData(19, false, currentSessionId);
